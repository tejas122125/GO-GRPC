...
func (c *wearableServiceClient) BeatsPerMinute(ctx context.Context, in *BeatsPerMinutesRequest, opts ...grpc.CallOption) (WearableService_BeatsPerMinuteClient, error) {
	stream, err := c.cc.NewStream(ctx, &WearableService_ServiceDesc.Streams[0], "/wearable.device.WearableService/BeatsPerMinute", opts...)
	if err != nil {
		return nil, err
	}
...
var WearableService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wearable.device.WearableService",
